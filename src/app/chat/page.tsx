      ...
      try {
        ...
        if (mData) {
          ...
          const constructedMatch: ConversationItem = {
            ...
            course: other?.course || null,
            age: other?.age || null,
            lastMessage: mData.last_message || 'Say hello 👋',
          ...
          {conversationsLoading ? (
            ...
            filteredConversations.map(c => (
              <Link
                ...
                className={`chat-list-row ${c.unreadCount > 0 ? 'unread' : ''} ${c.id === matchId ? 'active' : ''}`}
              >
      ...
      <div className="chat-main-col">
        {activeMatch ? (
            ...
            {isSelectMode ? (
              ...
              <nav className="chat-header">
                <div className="chat-header-left">
                  ...
                  <div className="user-profile" onClick={handleViewProfile} style={{ cursor: 'pointer' }}>
              ...
              >
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setSelectedMessageIds([msgContextMenu.message.id])
                    setMsgContextMenu(null)
                  }}
                >
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="chat-desktop-empty">
            ...
            <p className="chat-desktop-empty-desc">
              Select a conversation from the left sidebar to start chatting or view message history.
            </p>
          </div>
        )}
      </div>
